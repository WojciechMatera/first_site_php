...
<div id="menu2" class="change_window">
   <div id="menu" class="clearfix">
        ...
        <ul>
           <li ><a href="index.php"><b>Strona główna</b></a></li>
			...
			<div id="menu3" class="change_windows">
	
	<p style="position: relative;top: -7px;left: 30px; font-size: 20px;">Kursy - TPascal</p>
	</div>
 ...
 <div id="prawy_boczny" > </div>
	...
	<div id="kol_2">	
		  <div id="glowny" class="change_windows" style="  padding: 10px;width:755px; " >
            ...
            while ($row = mysql_fetch_array($result)) {
				...
				echo '<h2><p style="font-size:20px;">'.stripslashes($row['kolumna2']).'</p></h2><br/>';
